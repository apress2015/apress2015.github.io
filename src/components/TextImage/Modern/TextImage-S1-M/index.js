...
const TextImageS1M = () => {
  return (
    <div
      className={`TextImageS1M relative max-w-max mx-auto lg:pb-20 lg:flex px-4 lg:gap-24 lg:px-0  `}
    >
      <div
        className={
          "flex  flex-col lg:absolute z-10 bottom-0 right-16 lg:w-[432px] lg:h-[432px] lg:opacity-80 lg:rounded-12 overflow-hidden "
        }
      >
        <img
          className={"w-full h-full mt-auto  object-cover "}
      ...
      <div className="text-container flex flex-col items-center lg:items-start p-8 lg:p-16 lg:pr-[520px]    ">
        <div
          className={"flex flex-col lg:flex-row lg:gap-4 items-center lg:mb-4"}
        >
          <svg
            width="41"
            height="41"
          ...
          <h2 className="title text-[#617AFF] mb-4 lg:mb-0     text-32  ">
            OUR TEAM
          </h2>
        </div>
