  ...
  return (
    <div className=" ContactUsM  lg:py-[120px]">
      <section className={` helpSection`}>
        <div className="max-w-max m-auto flex  flex-col lg:flex-row items-center py-8 px-4 lg:mt-10 lg:py-10 lg:px-28">
          <div className="lg:w-[70%]">
            <h5 className="text-36 font-medium lg:text-4xl lg:leading-[48px]">
              How can we help...
            </h5>
          ...
          >
            <h5 className="text-36 lg:text-[40px] lg:leading-[53px] text-center mb-6">
              Contact Us
            </h5>
            <input
              type="text"
      ...
      <section className={`helpSection`}>
        <div className="max-w-max m-auto flex  flex-col lg:flex-row items-center py-8 px-4 lg:mt-10 lg:py-10 lg:px-28">
          <form
            className="w-full flex flex-col lg:ml-10 lg:w-[30%] mt-10 lg:mt-0 order-2 lg:order-1"
            action="src/components"
          >
            <h5 className="text-36 lg:text-[40px] lg:leading-[53px] text-center mb-6">
              Contact Us
