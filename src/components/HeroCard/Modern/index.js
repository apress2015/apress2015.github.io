    ...
    <div className=" HeroCardM w-full max-w-max mx-auto lg:py-[160px]">
      <section className={`rounded-16 cardSection`}>
        <div className="mt-16">
          <div className="flex justify-center items-center py-10">
            ...
            <h3 className="font-bold text-[24px] leading-[28px] lg:text-[40px] lg:leading-[48px] px-4">
              Sold Properties
            </h3>
      ...
      <section className={`mt-72 mb-72 lg:my-16 cardSection`}>
        <div className="flex mx-10 items-center justify-between translate-y-[115%] lg:translate-y-full">
          <h3
            className={`font-bold text-[24px] leading-[28px] lg:text-[40px] lg:leading-[40px] p-4 lg:p-5 rounded-16 bg-[#fff]`}
          >
            Sold Properties
          </h3>
          <div className="flex">
        ...
        <div
          className={`flex flex-col h-[400px] lg:h-[500px] lg:flex-row lg:justify-center items-center mt-10 rounded-16 lg:p-5 backgroundSectionSecond`}
        >
          <div
            className={`p-4 lg:p-10 mt-60 lg:mt-[490px] w-full lg:w-auto lg:rounded-16 flex flex-col items-center content`}
          >
            <h4 className="font-bold text-[24px] leading-[24px] lg:text-[36px] lg:leading-[41px]">
              11 5152 Canada Way, Burnaby
            </h4>
