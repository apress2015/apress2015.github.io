...
const HeaderS13M = () => {
  return (
    <header
      className={`HeaderS13M text-white relative text-[#363853]  text-center `}
    >
      ...
      <div className={`relative z-10 lg:h-[834px]  p-4 lg:p-10`}>
        <nav className={`w-full lg:px-11 lg:py-[15px] `}>
          <img
            ...
            className={"w-16 lg:w-32 mx-auto mb-10"}
            alt=""
          />
          <ul
          ...
          <span
            className={`flex justify-center text-[#363853] text-12 sm:text-14 lg:text-20 gap-6 roboto items-center mb-16`}
          >
        ...
        <div className={`flex pb-10 flex-col text-[#363853] justify-center`}>
          <h1
            className={`font-bold lato mb-2 text-40 lg:text-64 lg:leading-[85px] tracking-[0.24em]`}
          >
            FIRST FOLD
          </h1>
          <h2
            className={`text-16 lato tracking-[-0.04em] lg:text-36 lg:leading-[42px] mb-12 lg:tracking-[-0.04em] roboto font-light`}
          >
          ...
          <div
            className={`flex justify-center w-full lg:w-[40%] lato  mx-auto justify-between text-left  mt-8 mb-16`}
          >
