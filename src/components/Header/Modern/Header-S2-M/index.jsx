        ...
        <div className={`w-full`}>
          <nav className={`w-full mx-auto py-4 px-7 lg:px-11 lg:py-[15px]`}>
            <div className="flex max-w-max mx-auto text-white items-center">
              ...
              />
              <ul
                className={`hidden lato lg:flex list-none items-center text-[#363853] child:pr-6`}
              >
                <li>Home</li>
                <li>Projects</li>
                <li>Plans</li>
              ...
              <span
                className={`flex flex-col text-[#363853] lato font-normal ml-auto items-end text-14 lg:text-16`}
              >
          ...
          <div
            className={`px-4 max-w-max mx-auto flex-col lg:flex-row flex mt-2 lg:mt-[32px] justify-between`}
          >
            <div className="text-black flex flex-col order-2 lg:order-1 pt-10 lg:pt-[70px] lg:w-[50%] px-0 lg:pr-[50px] text-left h-[100%]">
              <div className={" mb-[24px] mx-auto lg:mx-0 "}>
                <h1 className="font-bold text-40  lato lg:text-[53px] tracking-[.24em]  ">
                  FIRST FOLD
                </h1>
              ...
              <p className="font-normal lato text-[#363853] text-16 md:text-[24px] mb-[32px]">
              ...
              <div className="w-full flex-row flex">
                <input
                  className="border-1 rounded-l-8 lato text-20 border-[#363853] placeholder-[#363853] w-full py-4 px-8"
                  type="text"
              ...
              <div className="mt-10 px-8 lato lg:px-0 lg:mt-[100px] flex justify-between">
                <div>
                  <p className="font-light text-16 lg:text-[24px] text-[#363853]">
                    Properties Sold
                  </p>
                  <p className="font-black text-20 lg:text-[36px] text-[#363853]">
                    157 K
                  </p>
                </div>
                <div>
            ...
            <div
              className={`text-white order-1  relative w-full h-[350px] lg:w-[50%] lg:h-[800px]`}
            >
              <img
                src="/media/firstfold/Rectangle 47.png"
                className={"w-full h-full absolute object-cover rounded-12"}
                alt=""
              />
            </div>
          </div>
