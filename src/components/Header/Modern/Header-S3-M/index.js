        ...
        <div className={`w-full  `}>
          <nav className={`w-full mx-auto py-2 px-7 lg:px-11 lg:py-[15px]`}>
            <div className="flex max-w-max mx-auto text-white items-center">
              ...
              />
              <ul
                className={`hidden lato lg:flex list-none text-black items-center child:pr-6`}
              >
                <img
                  className={"w-20 "}
                  src="/media/footer/WATERMARK_dark-04%201.png"
          ...
          <div
            className={`max-w-max  mx-auto mt-auto flex-col flex lg:mt-[32px] px-4 lg:px-10 pb-0 lg:pb-4 py-20 w-full  relative justify-between `}
          >
            <img
              className={
            ...
            <div className="text-black order-2 bg-white/40 max-w-[600px] backdrop-blur-[32px] rounded-8   lg:order-1 py-6   lg:w-[50%] mx-auto  px-4 lg:px-8 ">
              <div className={" mb-[0px]"}>
                <h1 className="font-bold lato text-28 px-7 lg:px-10 py-1 lg:py-3 lg:text-[53px] tracking-[.20em] ">
                  FIRST FOLD
                </h1>
              </div>
              <p className="font-light text-[#363853] lato text-16 md:text-[24px] text-left mb-[32px]">
              ...
              <div className="w-full flex-row flex">
                <input
                  className="border-1 lato w-full text-[#363853] text-14 border-[#363853] bg-transparent placeholder-[#363853] w-full py-4 px-4 rounded-l-8"
                  type="text"
